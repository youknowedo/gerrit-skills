...
2. Build the message using the style guide:
...
3. Jira prompting controls:
- Default behavior: ask for Jira when committing and Jira is missing.
...
4. Create and apply commit message:
...
- Ask for Jira issue before commit when not already known.
